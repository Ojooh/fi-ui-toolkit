...
class PasswordInputUIConfig extends BaseConfig { 

    constructor() { super("password_input_ui_config"); }
    ...
    getUIProps() { 
        const input_ui_default_config = {
            id: "password_id", name: "password", value: null, placeholder: null, 
...
export default PasswordInputUIConfig;