...
import TextInputUIProps         from "./text_input_ui_props";
import TextInputUIController    from "./text_input_ui_controller";

const props         = defineProps(TextInputUIProps);
const controller    = new TextInputUIController(props);
